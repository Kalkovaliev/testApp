...
import com.pelagusit.store.repository.AuthorityRepository;
...
import com.pelagusit.store.service.util.RandomUtil;
...
public class UserService {
    ...
    public void updateUserInformation(String login,String firstName, String lastName, String email) {
...
public boolean isOverlap(String username) {
		
		List<User> list = new ArrayList<User>();
		list = userRepository.findUser(username);
		if (list.size() == 0) {
			return false;
		} else {
			return true;
