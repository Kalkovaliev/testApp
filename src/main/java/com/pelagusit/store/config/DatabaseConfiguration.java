...
@Configuration
@EnableJpaRepositories("com.pelagusit.store.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.pelagusit.store.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.pelagusit.store.domain");
        return basePackages;
    }
