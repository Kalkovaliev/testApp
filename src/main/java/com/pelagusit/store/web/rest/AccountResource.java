...
import com.pelagusit.store.domain.PersistentToken;
import com.pelagusit.store.domain.User;
import com.pelagusit.store.repository.PersistentTokenRepository;
import com.pelagusit.store.repository.UserRepository;
import com.pelagusit.store.security.SecurityUtils;
import com.pelagusit.store.service.MailService;
...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@RequestBody UserDTO userDTO, HttpServletRequest request,
       ...
       user = 	userService.createUserInformation(userDTO.getLogin(), userDTO.getPassword(), userDTO.getFirstName(),userDTO.getLastName(),userDTO.getEmail(),userDTO.getLangKey(),userDTO.isActivated());
   ...
   //         mailService.sendActivationEmail(user.getEmail(), content, locale);
    ...
    public void saveAccount(@RequestBody UserDTO userDTO) {
        userService.updateUserInformation(userDTO.getLogin(),userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail());
    }
